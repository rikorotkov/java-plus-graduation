...
public class EventSpecifications {
    ...
    public static Specification<Event> eventAdminSearchParamSpec(EventAdminSearchParam params) {
        return Specification.allOf(EventSpecifications.userIdIs(params.getUsers()))
    ...
    public static Specification<Event> eventPublicSearchParamSpec(PublicEventSearchParam params) {
        return Specification.allOf(EventSpecifications.textInAnnotationOrDescription(params.getText()))
                .and(EventSpecifications.categories(params.getCategories()))
    ...
    public static Specification<Event> eventFeedSearchParamSpec(List<Long> followedUsersIds,
        ...
        return Specification.allOf(EventSpecifications.userIdIs(followedUsersIds))
